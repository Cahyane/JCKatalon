...
txtDashboard = WebUI.getText(findTestObject('Object Repository/Page_OrangeHRM/h6_Dashboard'))

println('Page: ' + txtDashboard)

WebUI.getText(findTestObject('Page_OrangeHRM/h6_Dashboard'))
